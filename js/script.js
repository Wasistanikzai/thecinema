...
function celebrities() {
    ...
    for (let i = 0; i < actors.length; i++) {
        ...
        actorsMovie.className = 'col-lg-8 col-md-8 col-sm-12 movie-link';
        ...
        actorsMovieDetails.className = 'col-lg-8 col-md-8 col-sm-8 align-top';
...
function displayData(data, counter) {
    ...
    for (var i = 0; i < moviesList.length; i++) {
        ...
        moviePoster.src = 'images/star_war.jpg';
...
function setMovieName(data, id, counter) {
    ...
    visitLink.addEventListener("click", function() {
        movieDetails(data.url, counter);
    });
    visitLink.className = 'btn btn-outline-primary btn-sm d-block btn-rounded mx-4 mb-1';
    visitLink.innerHTML = 'Details...';
